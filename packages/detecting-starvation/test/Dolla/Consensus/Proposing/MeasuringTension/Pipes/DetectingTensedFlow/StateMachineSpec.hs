...
module Dolla.Consensus.Proposing.MeasuringTension.Pipes.DetectingTensedFlow.StateMachineSpec (spec) where
...
import           Dolla.Consensus.Proposing.MeasuringTension.Pipes.DetectingTensedFlow.GenInput

import           Dolla.Consensus.Proposing.MeasuringTension.Pipes.DetectingTensedFlow.StateMachine
