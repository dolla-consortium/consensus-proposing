...
module Dolla.Consensus.Proposer.Receptionist.API.Server.Dependencies (Dependencies (..)) where
...
import           Dolla.Consensus.Proposer.Receptionist.API.Server.Settings
