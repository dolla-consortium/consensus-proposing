...
{-# LANGUAGE LambdaCase #-}
module Dolla.Consensus.Proposing.Staging.Pipes.Persisting.PipeSpec
  (spec) where
...
import           Dolla.Consensus.Proposing.Staging.Pipes.Persisting.Input
import           Dolla.Consensus.Proposing.Staging.Pipes.Persisting.Output
