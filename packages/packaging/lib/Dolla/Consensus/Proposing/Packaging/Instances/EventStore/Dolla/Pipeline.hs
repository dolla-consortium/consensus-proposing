...
module Dolla.Consensus.Proposing.Packaging.Instances.EventStore.Dolla.Pipeline (packaging) where
...
import qualified Dolla.Consensus.Proposing.Packaging.Instances.EventStore.Pipeline as OverEventStore
