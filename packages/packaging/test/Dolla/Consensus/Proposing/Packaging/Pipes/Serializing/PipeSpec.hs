...
module Dolla.Consensus.Proposing.Packaging.Pipes.Serializing.PipeSpec
  (spec) where
...
import           Dolla.Consensus.Proposing.Packaging.Pipes.Serializing.Output
import           Dolla.Consensus.Proposing.Packaging.Pipes.Serializing.GenInput
