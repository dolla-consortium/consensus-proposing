...
module Dolla.Consensus.Proposing.Receptioning.Execution.Environment.EventStore.Dolla.Warp.Server.Server
...
import qualified Dolla.Consensus.Proposing.Receptioning.Execution.Environment.EventStore.Dolla.Warp.Server.Dependencies as Server
import           Dolla.Consensus.Proposing.Receptioning.Execution.Environment.EventStore.Dolla.Service
